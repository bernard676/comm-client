    ...
    <ChatboxLayout>
      <div className="min-h-screen flex flex-col">
        ...
        <div className="sticky bottom-0">
          <form>
            <div className="mb-4 w-full bg-gray-500 border border-gray-300 dark:bg-gray-600 dark:border-gray-600">
              <div className="py-2 px-4 bg-white dark:bg-gray-500">
                ...
                <textarea
                  ...
                  id="comment" rows="2" 
                  className="px-0 w-full text-sm text-gray-900 bg-white border-none dark:bg-gray-500 dark:text-white dark:placeholder-gray-400" 
